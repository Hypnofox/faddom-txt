...
### Q: "How does this work with our existing tagging structure?"

**Crisp Answer:**
"Faddom automatically imports tags from VMware, AWS, Azure, GCP, and Nutanix through their native APIs. Cost center tags, environment tags, owner tags, compliance tags - everything.

You can then:
- Build maps directly from tags ('show me everything tagged Production-Finance')
- Filter views by tags  
- Group dependencies by tags
- Export tag-based reports

The only platform that doesn't export tags automatically is Hyper-V - for those environments, you can import tags manually via CSV or API.

This means your existing organizational structure - the tags your finance team uses for chargeback, the tags your cloud team uses for governance - they instantly become powerful visibility filters in Faddom. No duplicate tagging required."

**Why this works:** Shows Faddom leverages existing investments, doesn't create new work.

---

### Q: "Can we see which users depend on which applications?"

**Crisp Answer:**
"Yes, through Active Directory integration. Faddom reads Windows event logs and correlates user logins with server access to build user dependency maps.

You can see:
- Which servers and applications each user actually relies on (not just what AD says they *can* access, but what they *actually* use)
- When they last logged in
- Dormant accounts that haven't been used in 90+ days
- Abnormal access patterns (user logging in at unusual times or from unusual systems)

This answers three critical questions:
1. Who will be affected when we take this server down?
2. What should we disable when this person leaves?
3. Are there security anomalies in user behavior?

Requires WMI access for Windows, SSH for Linux - same permissions your monitoring tools use."

**Why this works:** Addresses security, operations, and offboarding - three different pain points.
